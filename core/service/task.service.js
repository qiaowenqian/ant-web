...
export function getTaskListByCondition(
  pageNo,
  pageSize,
  data,
  callback,
...
export function getTaskListByConditionNew(data, callback, isSmall) {
  HttpClient.AjaxPost(
    "/taskHome/findIndexNum",
    data,
    list => {
      callback(list);
    },
...
// 邀请关注
export function attentionUsers(taskId, users, joinProject, callback, isSmall) {
  const data = {
    objectId: taskId,
    rtype: "b",
    users: users,
...
export function setMilestoneWithTask(taskId, callback, isSmall) {
  HttpClient.AjaxPost(
    "/taskinfo/updateMilestoneIndex?id=" + taskId,
    "",
    list => {
      callback(list);
    },
...
//批量修改任务数据（带权限）
export function batchUpdata(data, callback, isSmall) {
  HttpClient.AjaxPost(
    "/taskinfo/isModify",
    data,
    list => {
...
export function updateMoreTaskData(proId, data, callback, isSmall) {
  HttpClient.AjaxPost(
    "/taskinfo/taskinfoUpdaleAll?progectId=" + proId,
    data,
    list => {
      callback(list);
    },
...
// 获取任务详情数据
export function getTaskDetailsDataById(
  taskId,
  proId,
  hideOkTask = false,
  callback,
  ...
  HttpClient.AjaxPost(
    "/taskinfo/findByTaskinfoId?id=" + taskId + "&projectId=" + proId,
    { hidden: hideOkTask },
    list => {
      callback(list);
    },
...
export function getChildTaskById(id, callback, isSmall) {
  HttpClient.AjaxPost(
    "/taskinfo/findChildTaskinfo?id=" + id,
    "",
    list => {
      callback(list);
    },
...
export function getTaskFilesById(id, callback, isSmall) {
  HttpClient.AjaxPost(
    "/taskinfo/findTaskinfoFiles?tId=" + id,
    "",
    list => {
      callback(list);
    },
...
export function urgeTaskById(
  ...
  HttpClient.AjaxPost(
    ...
    { taskSignRemarks: taskSignRemarks, id: idArr },
    list => {
      callback(list);
    },
    isSmall
...
export function urgeTaskByIdMore(
  taskSignRemarks,
  id,
  tid,
  type,
  ...
  HttpClient.AjaxPost(
    "/taskinfo/expedite?tid=" + tid + "&type=" + type,
    { taskSignRemarks: taskSignRemarks, id: id },
    list => {
      callback(list);
    },
    isSmall
...
export function deleteCoopTaskById(recordId, nowTaskId, callback, isSmall) {
  HttpClient.AjaxPost(
    "/taskrrelation/deleteTaskrTelation?id=" +
    recordId +
    "&taskinfo=" +
    nowTaskId,
    "",
...
export function createTask(progectId, parentId, data, callback, isSmall) {
  HttpClient.AjaxPost(
    "/taskinfo/addTaskinfo?progectId=" + progectId + "&pid=" + parentId,
    data,
    list => {
      callback(list);
    },
...
export function createTaskCycele(projectId, data, callback, isSmall) {
  HttpClient.AjaxPost(
    "/cycleTask/cycleTaskinfo?projectId=" + projectId,
    data,
    list => {
      callback(list);
    },
...
export function moveTask(taskId, parentId, type, callback) {
  HttpClient.AjaxPost(
    "/taskinfo/relateFatherTaskNew?resourceId=" +
    taskId +
    "&targetId=" +
    parentId +
    "&type=" +
...
export function getFormulaById(id, callback) {
  HttpClient.AjaxPost(
    "/calculate/getPrefTypeByProjectId?projectId=" + id,
    "",
    list => {
      callback(list);
    }
...
export function getTaskBreadById(projectId, taskId, callback, isSmall) {
  HttpClient.AjaxPost(
    "/taskinfo/findByProjectId?id=" + projectId + "&pid=" + taskId,
    "",
    list => {
      callback(list);
    },
...
//获取@的人员列表
export function getAtSelectUser(bodyobj, callback) {
  //   HttpClient.AjaxGet("/ant-cgi/user/selectUser", data => {
  //     callback(data);
  //   });
  HttpClient.AjaxPost("/user/selectUser/", bodyobj, data => {
    callback(data);
  });
}
...
// pageNo = 1,
//获取已删除的任务列表
export function taskRecycled(pageSize, pageNo, callback) {
  HttpClient.AjaxGet(
    "/taskinfo/taskRecycleBin?pageSize=" + pageSize + "&pageNo=" + pageNo,
    list => {
      callback(list);
    }
  );
...
//恢复已删除的Task
export function restoreTaskinfo(taskId, callback) {
  HttpClient.AjaxPost("/taskinfo/restoreTaskinfo", { id: taskId }, list => {
    callback(list);
  });
}
...
export function removeTask(taskId, callback) {
  HttpClient.AjaxPost("/taskinfo/removeCompletely", { id: taskId }, list => {
    callback(list);
  });
}
//获取循环任务列表
export function findCyclicTaskList(search, callback) {
  HttpClient.AjaxPost(
    "/cycleTask/findCyclicTaskList",
    { search: search },
    list => {
      callback(list);
    }
...
//修改循环任务cycleTask/\updateMoreIndex
export function updateMoreIndex(updata, callback) {
  HttpClient.AjaxPost("/cycleTask/updateMoreIndex", updata, list => {
    callback(list);
  });
}
//删除循环任务cycleTask/\deleteCycleTaskinfo
export function deleteCycleTaskinfo(id, projectId, callback) {
  HttpClient.AjaxPost(
    "/cycleTask/deleteCycleTaskinfo?id=" + id + "&projectId=" + projectId,
    list => {
      callback(list);
    }
  );
...
//新增的单独获取日志和动态的接口
export function getListLeave(id, callback) {
  HttpClient.AjaxPost("/taskinfo/getlistLeave?id=" + id, {}, list => {
    callback(list)
  })
}
