...
export default class dingLogin extends React.Component {
  ...
  componentDidMount() {
    //免登时确定session与cookies,携带jeeditesessionid
      ...
      <div className="dingLoging">
        ...
        <div className="loadBox">
          <div className="logoTop">
            <img src="../static/react-static/pcvip/imgs/logoLoading.png?t=1.666" />
          </div>
          <div className="logoBott">
            <img src="../static/react-static/pcvip/imgs/logoLoad.png?t=1.666" />
          </div>
        </div>
      </div>
    );
