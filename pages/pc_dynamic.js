...
export default class Dynamic extends React.Component {
  ...
  getDynamicData(pageNo, users, proIds, date) {
    ...
    getDynamicList(pageNo, dynamicSearch, res => {
      ...
      this.setState({
        dynamicListNowPage: res.result.pageNo,
        dynamicListAllPage: res.result.last
      });
      this.setState({
        dynamicListLoading: false,
        dynamicListMoreLoading: false
          ...
          <Content className="d-bg-gray d-flex-con dynamic">
            <div className="d-bg-white dynamic-filter">
              <div className="dynamic-filter-item">
                ...
                <div className="ct">
                  <Select
                    ...
                    placeholder="请选择项目"
                    onChange={val => {
                      this.setState({ dynamicSearProIds: val });
                      this.getDynamicData(1, "", val, "");
                    }}
              ...
              <div className="dynamic-filter-item" style={{ border: "0" }}>
                ...
                <div className="ct">
                  <UserTag
                    selectedUsers={dynamicSearUsers}
                    selectedUsersOnchange={val => {
                      this.selectedUsersOnchange(val);
                    }}
                    selectUserTitle="人员"
                  />
                </div>
              ...
              <div className="dateSearch_row">
                ...
                <div className="ct">
                  <DatePicker
                    value={moment(dynamicSearDate, "YYYY-MM-DD")}
                    onChange={val => {
                      const da = dateToString(new Date(val), "date");
                      this.setState({ dynamicSearDate: da });
                      this.getDynamicData(1, "", "", da);
            ...
            <div className="filter-main">
              <div className="filter-main-list d-bg-white">
                <p className="bb f14 main-title">动态列表</p>
                <div
                  className="container"
                  onScroll={e => {
                    this.scrollOnBottom("dynamic", e);
                  }}
                >
                  ...
                  {!dynamicListMoreLoading &&
                  dynamicListNowPage < dynamicListAllPage &&
                  dynamicListLoadingCount !== "err" ? (
