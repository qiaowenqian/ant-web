...
import {
  ...
  findTypeList,
  getDetail
} from "../core/service/help.service";
      ...
      <div className="help">
        ...
        <div className="box">
          <div className="left">
            {/* <Spin spinning={} /> */}
            <Menu
              onClick={thim => this.handleClick(thim)}
                ...
                ? typeList.map((item, i) => {
                    return (
                      <Menu.Item key={item.type}>
                        {item.type} <span className="lab">{item.count}</span>{" "}
                        <Icon type="right" />
                      </Menu.Item>
                    );
                  })
          ...
          <div className="right">
            <div className="top">
              <div className="search">
                ...
                />
                <div className="but" onClick={this.search}>
                  搜索
                </div>
              </div>
            </div>
            ...
            <table className="bottom">
              <tbody>
                ...
                {list && list.length > 0 ? (
                  list.map((item, i) => {
                    return (
                      <tr onClick={e => this.showDeatil(item.id, e)} key={i}>
            ...
            <div className={this.state.classDet}>
              <div className="user_box">
                ...
                <div className="but">
                  <Button
                    type="primary"
                    onClick={() => this.setState({ detailShow: false })}
                  >
                    关闭
                  </Button>
                </div>
