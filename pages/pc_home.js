...
export default class Home extends React.Component {
  ...
  userTaskChart(date, isDraw) {
    var userTaskChart = echarts.init(
      document.getElementById("userTaskChartBox")
    );
    if (isDraw === "重绘") {
  ...
  userMoneyData(projectIds, date, isDraw) {
    var userTaskChart = echarts.init(
      document.getElementById("userMoneyChartBox")
    );
    if (isDraw === "重绘") {
      userTaskChart.resize();
      return false;
        ...
        <Content className="homePage">
          <div className="homePage_top">
            ...
            <div className="titBox">
              ...
              <div className="max">
                {userBusData.projectCount ? userBusData.projectCount : 0}
              </div>
            </div>
            <div className="line" />
            <div className="titBox">
              ...
              <div className="max">
                {userBusData.unTask ? userBusData.unTask : 0}/
                {userBusData.totalTask ? userBusData.totalTask : 0}
              </div>
            </div>
            <div className="line" />
            <div className="titBox">
              ...
              <div className="max">
                {userBusData.allConten ? userBusData.allConten : 0}
              </div>
            </div>
          </div>
          <div className="homePage_bottom">
            <div className="homePage_bottom_left">
              <div className="tit_row" style={{ flex: "0 0 auto" }}>
                ...
                />
                {/*<a style={{ float: 'right' }}>全部动态</a>*/}
              </div>
              <div
                className="dy_row_box"
                onScroll={e => {
                  this.messageScroll(e);
                }}
              >
                ...
                {userMessageList && userMessageList.length > 0 ? (
                  userMessageList.map(item => {
                    ...
                    for (var o in content) {
                      arr.push(
                        <span style={{ display: "inline-block" }} key={o}>
                          {o == "讨论内容" ? (
                            <div
                    ...
                    return (
                      <div className="dy_row" key={item.id}>
                        <div className="user">{item.createBy.name}</div>
                        <div className="cont">
                          <div className="dyText">
                            {item.subject} <span>{arr[0]}</span>
                          </div>
                          <p>{item.createDate}</p>
                        </div>
                      </div>
                ...
                {!userMessageMoreLoading &&
                userMessageNowPage < userMessageLastPage ? (
                ...
                <div className="box">
                  <div className="tit_row">
                    ...
                    <RadioGroup
                      ...
                      size="small"
                      onChange={e => {
                        this.userTaskChart(e.target.value);
                      }}
                    >
                  ...
                  <div className="cont_box">
                    ...
                    <div className="div" id="userTaskChartBox" />
                    <div
                      className="div"
                      style={{
                        display: "flex",
                    ...
                    >
                      {userTaskChartText.map((item, i) => {
                        return (
                          <div className="li" key={i + "userTaskChartText"}>
                            <div
                              className="dian"
                ...
                <div className="box">
                  <div className="tit_row">
                    ...
                    <RadioGroup
                      ...
                      size="small"
                      onChange={e => {
                        this.userMoneyData("", e.target.value);
                      }}
                    >
                      <RadioButton value="all">全部</RadioButton>
                      <RadioButton value="month">本月</RadioButton>
                  ...
                  <div className="cont_box">
                    ...
                    <div className="div" id="userMoneyChartBox" />
                    <div
                      className="div"
                      style={{
                        display: "flex",
                    ...
                    >
                      {userMoneyText.map((item, i) => {
                        return (
                          <div className="li" key={i + "userMoneyText"}>
                            <div
                              className="dian"
