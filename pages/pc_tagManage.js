...
export default class tagManage extends React.Component {
  ...
  handleKeyup(e) {
    ...
    //以防万一
    if (value.charCodeAt(0) == 10 && value.length == 1) value = "";
  }
  //个人标签
  personLabelRender() {
    ...
    if (this.props.url.query.type == "1") {
              ...
              parentList.map((item, i) => {
                return (
                  <li key={i}>
                    <Checkbox
                      onChange={e => {
                        this.selectLabel(e, item.id);
                      }}
                      checked={indexList.indexOf(i) == -1 ? false : true}
                      onClick={() => {
                        this.labelClickTwo(item.id, i);
                      }}
                    />
                    <ContentEditable
                      className="labelName"
                      ...
                      disabled={false}
                      onChange={e => {
                        that.setState({ twoLabelEditName: e.target.value });
                      }}
                      onBlur={() =>
                        that.labelEdit(
                          item.id,
                      ...
                      onClick={() => {
                        that.setState({ twoLabelOldName: item.labelname });
                      }}
                      onKeyDown={e => {
                        this.handleKeyup(e);
                      }}
      ...
      return (
        <div className="content_bottom">
          <h3>
            {tagList && tagList[tagIndex] ? tagList[tagIndex].labelname : ""}
          </h3>
          <div style={{ flex: "1", overflow: "auto" }}>
            <ul>
              {tagList &&
              tagList[tagIndex] &&
              tagList[tagIndex].parentList &&
              tagList[tagIndex].parentList.length > 0 ? (
                tagList[tagIndex].parentList.map((item, index) => {
                  return (
                    <li key={index}>
                      <Checkbox
                        onChange={e => {
                        ...
                        checked={indexList.indexOf(index) == -1 ? false : true}
                        onClick={() => {
                          this.labelClickTwo(item.id, index);
                        }}
                      />
                      <ContentEditable
                        className="labelName"
                      ...
                      <Cascader
                        ...
                        onChange={time => this.onChangeLabelParent(time, item)}
                      >
    ...
    return (
      <div
        onClick={e => {
          e.stopPropagation();
          e.preventDefault();
          this.setState({ exitShow: false, addsecondShow: false });
        }}
      >
        ...
        <div className="tagBox">
          {leftMenuShow ? (
            <div className="menu_left">
                  ...
                  <div className="selBox">
                    <div>
                      <Select
                        value={selectColor}
                        className={
                          "choose " + getTagColorByColorCode("1", selectColor)
                        }
                        onChange={e => {
                          this.changeColor(e);
                        }}
                              ...
                              return (
                                ...
                                >
                                  <div
                                    className={
                                      "selColor " +
                                      getTagColorByColorCode("1", color.value)
                                    }
                                    style={{ marginTop: "5px" }}
                                  />
                                </Select.Option>
              ...
              <div className="left_bottom">
                {that.props.url.query.type == "3" ||
                that.props.url.query.type == "2"
                          ...
                          <div
                            ...
                            onClick={() => {
                              ...
                              if (
                                ...
                                this.setState({ oneEditIndex: null });
                              } else {
                                this.setState({
                                  oneEditIndex: i,
                                  oneLabelOldName: item.labelname
                                });
                              }
                            }}
                            onMouseOver={() => {
                              that.setState({ oneDeleteIconIndex: i });
                            }}
                            onMouseOut={() => {
                              that.setState({ oneDeleteIconIndex: null });
                            }}
                          >
                            {i == tagIndex ? (
                              <Select
                                value={sColor ? sColor.substring(1) : ""}
                                onChange={e => {
                                  this.updateLabelColor(e, mainTag);
                                }}
                              >
                                {colorList && colorList.length > 0
                                  ? colorList.map((color, index) => {
                                  ...
                                  : ""}
                                {colorList &&
                                colorList.indexOf(sColor.substring(1)) == -1 ? (
                                  <Select.Option
                                    value={sColor.substring(1)}
                                    key={item.id}
                                  >
                                    <span
                                      className={
                            ...
                            <span
                              className={
                                oneEditIndex == i ? "display-none" : "tagOne"
                              }
                            >
                              {item.labelname}
                            </span>
          ...
          <div className="content">
            <div className="content_top">
              <Button
                className={
                  indexList.length <= 0 ? "delete delete_click" : "delete"
                }
                type="primary"
              ...
              <div className="second">
                <Button
                  ...
                  onClick={e => {
                    e.stopPropagation();
                    e.preventDefault();
                    this.setState({ addsecondShow: true });
                  }}
                >
                ...
                {addsecondShow ? (
                  ...
                  >
                    <Input
                      ...
                      onChange={e => {
                        this.setState({ greateLabelName: e.target.value });
                      }}
                    />
                    <Button
                      type="primary"
