...
import stylesheet4 from "styles/components/common/contentLeft.scss";
      ...
      <Modal
        ...
        footer={[
          ...
          <Button key="submit" type="primary" className="save_button">
            ...
            />
            <div
              className="guideAlert guideAlert_top"
      ...
      <Content>
        ...
        <div className="opet_projectDetails">
            ...
            <RadioGroup value={"a"}>
              ...
              <RadioButton value="b" style={{ position: "relative" }}>
                ...
                {nowPage === 3 ? (
                  <div
                    ...
                    style={{ width: "230px", top: "100px", right: "0" }}
                  >
                    项目中的任务文件、讨论文件、成果文件，都在这里面。
                  </div>
                ) : (
                  ""
                )}
              ...
              <RadioButton value="c" style={{ position: "relative" }}>
                ...
                {nowPage === 3 ? (
                  <div
                    className="guideAlert"
                    style={{ width: "220px", top: "200px", right: "0" }}
                  >
                    图表化项目统计，一眼看清项目进展、任务概况。
                  </div>
                ) : (
                  ""
                )}
              ...
              <RadioButton value="d" style={{ position: "relative" }}>
                ...
                {nowPage === 3 ? (
                  <div
                    className="guideAlert"
                    style={{ width: "220px", top: "300px", right: "0" }}
                  >
                    其他家都没有的甘特图，我们蚂蚁分工有。
                  </div>
                ) : (
          ...
          <div className="pro_buts">
            ...
            >
              ...
              {nowPage === 5 || nowPage === 4 ? (
                <div
                  ...
                  style={
                    nowPage === 5
                      ? { width: "210px", top: "48px", left: "0" }
                      : { width: "190px", top: "48px", left: "0" }
                  }
                >
                  <div className="jt" style={{ left: "41px", right: "auto" }} />
            ...
            <Checkbox style={{ margin: "0 0 0 15px" }} checked={false}>
              隐藏已完成
            </Checkbox>
          </div>
            ...
            >
              <li style={{ position: "relative" }}>
                ...
                {nowPage === 6 ? (
                  <div
                    className="guideAlert"
                    style={{ width: "220px", top: "185px", right: "0" }}
                  >
                    功能强大的任务列表，助你合理安排每日工作。
                  </div>
                ) : (
                  ""
                )}
              ...
              <li style={{ position: "relative" }}>
                ...
                {nowPage === 6 ? (
                  <div
                    className="guideAlert"
                    style={{ width: "220px", top: "295px", left: "0" }}
                  >
                    事无巨细的动态列表，团队动态一目了然。
  ...
  taskDetailsRender() {
    return (
      <div className="taskDetails">
        ...
        <div
          className="guideAlert guideAlert_top"
          style={{ width: "210px", top: "201px", left: "15px" }}
        >
          <div className="jt" style={{ right: "auto", left: "16px" }} />
        ...
        <div className="title" style={{ top: "47px" }}>
          <div className="left">
            ...
            <div className="No textMore">1.23</div>
        ...
        <div className="taskDetailsScroll">
          ...
          <div className="switch">
            ...
            <div className="discuss">
              ...
              <div className="check">
                <Checkbox checked={true}>显示日志</Checkbox>
              </div>
            </div>
            {/*动态列表*/}
  ...
  render() {
    ...
    return (
      <Layout>
        ...
        />
        <div
          className="guideEndTxt"
          style={{ top: "15px", right: "163px" }}
          onClick={() => {
            this.guideEnd();
          }}
        >
        ...
        {nowPage === 5 ? (
          <div
            className="guideAlert guideAlert_top"
            style={{ width: "165px", top: "112px", right: "59px" }}
          >
            <div className="jt" />
            重要的任务记得关注
          </div>
        ...
        {(nowPage === 1) | (nowPage === 2) ? (
          <Content className="project">
            {nowPage === 2 && this.createProjectRender()}
                ...
                <div className="project-card">
                  ...
                  >
                    {nowPage === 1 && (
                      ...
                      >
                        <div
                          className="guideAlert guideAlert_right"
                          style={{ right: "-178px", top: "72px" }}
                        >
                          <div className="jt" />
                          开始创建一个项目
                        </div>
