    ...
    getProjectCreateInfoById(id, data => {
      ...
      if (data) {
        ...
        this.setState({
          ...
          proSelectedTags: proSelectedTags
        });
      }
    });
  }
    ...
    return (
      <Modal
        ...
        footer={[
          ...
          projectId ? (
            <Button
              key="delete"
              disabled={!jurisdiction ? true : false}
              onClick={() => {
                this.dellProject(projectId);
              }}
              className={!jurisdiction ? "showDel" : "cancelProject"}
            >
              删除该项目
            </Button>
          ) : (
          ...
          !jurisdiction ? (
            ...
            <Button
              ...
              type="primary"
              className={
                projectCreateInfo.proname == "" || !jurisdiction
                  ? "save_button"
                  : ""
              }
              onClick={e => this.projectUpate(e, "handleOk")}
              disabled={
                projectCreateInfo.proname == "" || !jurisdiction || saveLoading
                  ? true
                  : false
              }
            >
      ...
      >
          ...
          <div className="projectCreate-list">
            ...
            <div className="other proName">
              <Input
                ...
                value={projectCreateInfo.proname.slice(0, 30)}
              ...
              >
                <div className="pic-main" style={{ cursor: "pointer" }}>
                  <svg
                    ...
                    aria-hidden="true"
                    onClick={() => {
                      this.setState({ svnGroupShow: !svnGroupShow });
                    }}
                  >
        ...
        >
          ...
          <div className="other proDesc">
            <TextArea
              ...
              size="small"
              value={projectCreateInfo.proremark.slice(0, 200)}
            ...
            <div className="projectCreate-list">
              ...
              <div className="other">
                <div className="person-main">
                  ...
                  {jurisdiction && (
                    <div
                      className="person person-add"
                      onClick={() => this.selUser("1", "管理员", true)}
                    >
                      <Icon type="plus" />
                      {/* <span>添加</span> */}
                    </div>
              ...
              <div className="other">
                <div className="person-main">
                  ...
                  {jurisdiction && (
                    <div
                      className="person person-add"
                      onClick={() => this.selUser("0", "成员", true)}
                    >
                      <Icon type="plus" />
                      {/* <span>添加</span> */}
                    </div>
        ...
        >
          ...
          <div className="other">
            <RadioGroup
              onChange={e => this.projectUpate(e, "opentype")}
              disabled={!jurisdiction}
            >
              <Radio
                value={1}
